#ebastian Raschka 2014
# Python 3 script to atoms and residues in a PDB file.
# Command:  python renumber_pdb.py -i protein.pdb -a -r > output.pdb
# run
# ./renumber.py -h
# for help
#
...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--start', help='Number of the first residue in the renumbered file (default
 = 1)')
    ...
    parser.add_argument('-c', '--chainreset', action='store_true', help='Resets the residue renumbering af
ter encountering a new chain.')
